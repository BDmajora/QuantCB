...
#[pyfunction]
pub fn train_bpe(text_bytes: &[u8], target_vocab_size: usize) -> PyResult<Vec<((u32, u32), u32)>> {
        ...
        while curr != -1 {
            ...
            if next_idx != -1 {
                ...
                if list[idx].val == pair.0 && list[n_idx].val == pair.1 {
                    // Update stats for the neighbor to the left
                    if list[idx].prev != -1 {
                    ...
                    // Update stats for the neighbor to the right
...
#[pyfunction]
pub fn encode_bpe(tokens: Vec<u32>, merges: Vec<((u32, u32), u32)>) -> PyResult<Vec<u32>> {
...
#[pyfunction]
pub fn decode_bpe(tokens: Vec<u32>, merges: Vec<((u32, u32), u32)>) -> PyResult<String> {
